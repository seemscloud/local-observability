...
- `.portainer/admin-password` and `.portainer/encryption-key` are ignored runtime secrets that initialize the local Portainer `admin` account and encrypt a new Portainer database.
