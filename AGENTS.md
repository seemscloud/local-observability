...
- `config/grafana/dashboards/network-banana-pi-r4.json` defines the comprehensive `Network - Banana Pi R4` dashboard with a dynamic multi-router selector and metrics verified on both OpenWrt routers.
